...
contract BridgeRouter is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
        ...
        onlyBridgeProxy
    {
        ...
        emit BridgeInfoAddedToQueue(_srcChainId, _srcAddress, _nonce, _to, _amount);
    }
    ...
    event BridgeInfoAddedToQueue(uint16 _srcChainId, bytes _srcAddress, uint64 _nonce, address _to, uint256 _amount);
}
