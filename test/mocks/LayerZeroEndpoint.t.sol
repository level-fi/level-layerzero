...
import "../../src/layerzero/interfaces/ILayerZeroReceiver.sol";
import "../../src/layerzero/interfaces/ILayerZeroEndpoint.sol";
...
contract LayerZeroEndpoint is ILayerZeroEndpoint {
    ...
    function send(
        ...
        (uint256 nativeFee,) =
            estimateFees(_chainId, msg.sender, _payload, _zroPaymentAddress != address(0x0), adapterParams);
        ...
        LayerZeroEndpoint(lzEndpoint).receivePayload(mockChainId, srcUaAddress, dstAddr, nonce, extraGas, payload);
    }
    ...
    function _getProtocolFees(bool _payInZro, uint256 _relayerFee, uint256 _oracleFee)
        internal
        view
        returns (uint256)
    {
